...
class Block:
    ...
    # identify hash function and information that will be retained per hash
...
# create pychain class that will keep and update the pychain ledger as new blocks are created
...
# adds streamlit button to add new block with input information
